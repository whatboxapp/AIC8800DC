...
static int aicwf_usb_chipmatch(struct aic_usb_dev *usb_dev, u16_l vid, u16_l pid){
	...
	if(pid == USB_PRODUCT_ID_AIC8801){
		...
		return 0;
	}else if(pid == USB_PRODUCT_ID_AIC8800DC || pid == USB_PRODUCT_ID_TPLINK_AIC8800DC){
...
static struct usb_device_id aicwf_usb_id_table[] = {
    ...
    {USB_DEVICE_AND_INTERFACE_INFO(USB_VENDOR_ID_TPLINK, USB_PRODUCT_ID_TPLINK_AIC8800DC, 0xff, 0xff, 0xff)},
